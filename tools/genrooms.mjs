...
// ---------- Room 4: Cell Block — spark + conduction (48x24, floor top 21) ----------
{
  ...
  save("cell_block", "Cell Block B", g, "#1a1420", [
    ...
    { type: "npc", x: 8, y: 20, name: "Marla (#12)", color: "#7fd8e8",
      ...
      dialogAsk: "Psst. #47! Marla. #12. Got a GLOW MUSHROOM from the vents? I'll trade you something good. The Warden hates trades. Do it out of spite.",
    ...
    { type: "hint", x: 14, y: 17, text: "ice melts. ice shatters. the note is under it" },
